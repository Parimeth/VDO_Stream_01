...
public class Film_Pets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_film_pets);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://cdn-ktu-moive-streaming.box.com/shared/static/l3w657uft54urv4r1yqrgqwn5qahv959.mkv");
