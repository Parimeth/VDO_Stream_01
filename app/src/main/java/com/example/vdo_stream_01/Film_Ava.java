...
public class Film_Ava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_film__ava);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://cdn-ktu-moive-streaming.box.com/shared/static/z68rkznk456gxtnavkb1tblmcwajk6e1.mkv");
